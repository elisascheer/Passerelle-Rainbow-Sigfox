...
rainbowSDK.events.on('rainbow_onmessagereceived', function(message) {
    ...
    rainbowSDK.bubbles.createBubble("Bubble", "bubble for a doctor and his patients", withHistory).then(function(bubble) {
    // do something with the bubble created
        console.log("bubble created");
        rainbowSDK.bubbles.inviteContactToBubble(message.fromJid, Bubble, invitedAsModerator, sendAnInvite, inviteReason).then(function(bubbleUpdated) {
        // do something with the invite sent
            console.log("Doctor added to bubble");
        }).catch(function(err) {
        // do something if the invitation failed (eg. bad reference to a buble)
            console.log("Doctor not added to bubble");
        });
    }).catch(function(err) {
